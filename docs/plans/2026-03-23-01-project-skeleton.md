...
- Create: `SitRight/MainWindow.xaml`
- Create: `SitRight/MainWindow.xaml.cs`
- Create: `SitRight/Models/.gitkeep`
- Create: `SitRight/Services/.gitkeep`
- Create: `SitRight/ViewModels/.gitkeep`
- Create: `SitRight/Utils/.gitkeep`
- Create: `SitRight/Assets/.gitkeep`
...
```bash
cd SitRight
dotnet run --project SitRight.csproj
```
...
**Files:**
- Create: `SitRight/Models/DeviceState.cs`
- Create: `SitRight/Models/DeviceStateTests.cs`
...
```bash
git add SitRight/Services/.gitkeep SitRight/ViewModels/.gitkeep SitRight/Utils/.gitkeep
...
| 文件 | 描述 | 对应完整计划章节 |
|------|------|------------------|
| `SitRight.csproj` | .NET 8.0 WPF 项目 | 第4章 |
